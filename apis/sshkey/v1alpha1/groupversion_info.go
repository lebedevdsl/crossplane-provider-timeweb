...
// Group / Version metadata for the SSHKey managed-resource API.
const (
	Group   = "sshkey.m.timeweb.crossplane.io"
	Version = "v1alpha1"
)
...
var (
	// SSHKeyKind is the Kind name for SSHKey.
	SSHKeyKind = "SSHKey"
	// SSHKeyGroupVersionKind is the full GVK for SSHKey.
