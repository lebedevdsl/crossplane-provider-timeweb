...
// Group / Version metadata for the Cdn managed-resource API.
const (
	Group   = "cdn.m.timeweb.crossplane.io"
	Version = "v1alpha1"
)
...
var (
	// CdnKind is the Kind name for Cdn.
	CdnKind = "Cdn"
	// CdnGroupVersionKind is the full GVK for Cdn.
	CdnGroupVersionKind = GroupVersion.WithKind(CdnKind)
)
