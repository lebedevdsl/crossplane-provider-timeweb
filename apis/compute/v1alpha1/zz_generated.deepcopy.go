...
func (in *ServerResources) DeepCopyInto(out *ServerResources) {
	*out = *in
	...
	if in.CPUFrequencyTier != nil {
		in, out := &in.CPUFrequencyTier, &out.CPUFrequencyTier
		*out = new(string)
		**out = **in
	}
	if in.EnableLocalNetwork != nil {
		in, out := &in.EnableLocalNetwork, &out.EnableLocalNetwork
		*out = new(bool)
		**out = **in
	}
}
